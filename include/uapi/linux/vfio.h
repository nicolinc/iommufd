 ...
 * @ioas_id:	 the target ID of I/O address space or a hardware
 *		 page table.
 * @out_devid:	 the device id generated by this bind.
 * @out_hwpt_id: the hardware page table id generated by this bind.
 *
 * Return: 0 on success, -errno on failure.
 */
struct vfio_device_bind_iommufd {
...
/*
 * VFIO_DEVICE_ATTACH_IOMMUFD - _IOW(VFIO_TYPE, VFIO_BASE + 22,
 ...
 *
 * Avaiable only after a device has been bound to iommufd via
 * VFIO_DEVICE_BIND_IOMMUFD
 *
 * Undo per device fd close.
 *
 * @argsz:	user filled size of this data.
 * @flags:	must be 0.
