...
/**
 * enum iommu_hw_queue_type - Virtual Queue Type
...
enum iommu_hw_queue_type {
	 ...
	 *   IDR1.CMDQS to the huge page size divided by 16 bytes. An allocation
	 *   will fail, if the queue memory are not physically contiguous
	 */
 ...
 *
 * Allocate a HW queue object for a vIOMMU-specific HW-accelerated queue feature
