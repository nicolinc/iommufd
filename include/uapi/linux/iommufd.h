 ...
 *
 * User space must guarantee the queue memory to be physicallly contiguous. It's
 * suggested to cap the vSMMU's IDR1.CMDQS to limit the queue size within a huge
 * page and then use a size-aligned huge page to back the queue.
 */
 ...
 * @type: One of enum iommu_vcmdq_data_type
