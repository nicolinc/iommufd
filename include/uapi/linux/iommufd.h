 ...
 *    It must be set before attaching a device to an IOAS/HWPT, otherwise this
 *    option will be not effective on that IOAS/HWPT. User can choose to allow
 *    kernel to pick a base address, by simply ignoring this option or setting
