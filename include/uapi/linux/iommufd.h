 ...
 * @out_vintf_page0_base: The physical base address of the VINTF page0
 * @out_vintf_page0_size: The size of the VINTF page0
 *
 * Both @out_vintf_page0_base and @out_vintf_page0_size are given by the kernel
...
struct iommu_viommu_tegra241_cmdqv {
	__aligned_u64 out_vintf_page0_base;
	__aligned_u64 out_vintf_page0_size;
};
 ...
 *                                      (IOMMU_VQUEUE_TYPE_TEGRA241_CMDQV)
