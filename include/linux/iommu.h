 ...
 * @tdisp_t0: device remains associated with this IOMMU while TDISP is T=0. Its
 *            IOMMU driver uses its blocking domain while the core owns required
 *            operations such as ATS. Valid only when every device in a
 *            confidential-IOMMU group selects this state uniformly.
