 ...
 *            @attach_dev and @set_dev_pasid functions would only fail due to a
 *            temporary failure like out of memory. It's suggested to avoid the
 *            kernel prints in this op.
 *  Return:
 * * 0		- success
