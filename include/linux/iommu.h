 ...
 *                     include/uapi/linux/iommufd.h. Different from the existing
 *                     domain_alloc, driver should fully initialize a new domain
 ...
 *                     IOMMU_DOMAIN_NESTED, otherwise IOMMU_DOMAIN_UNMANAGED.
 *                     Upon failure, ERR_PTR will be returned.
