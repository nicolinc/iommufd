 ...
 *                           specific mechanisms.
 * @enforce_sw_msi: Domain needs (or not) to enforce a software-defined window
 *                  mapping onto the page table, required by an IOMMU that must
 *                  translate MSI doorbell locations.
...
struct iommu_domain_ops {
	...
	bool (*enforce_sw_msi)(struct iommu_domain *domain);
