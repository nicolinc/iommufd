...
extern int vfio_pin_pages(struct vfio_device *device, unsigned long user_iova,
			  int npage, int prot, struct page **phys_page);
extern int vfio_unpin_pages(struct vfio_device *device, unsigned long user_iova,
			    int npage);
