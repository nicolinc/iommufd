 ...
 * @DEV_FLAG_DMA_PRIVATE: The device reaches private (encrypted) memory, so the
 *		DMA API never has to hand it the shared alias of a buffer. Set
 *		by the layer that knows how the device's DMA is translated.
