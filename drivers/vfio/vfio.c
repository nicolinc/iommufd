 ...
 * domain only.
 * @device [in]  : device
 * @user_iova    : starting IOVA of user/guest pages to be pinned.
 ...
 */
int vfio_pin_pages(struct vfio_device *device, unsigned long user_iova,
 ...
 * @device [in]  : device
 * @user_iova    : starting address of user/guest pages to be unpinned.
 * @npage [in]   : count of pages to be unpinned.  This count should not
 *                 be greater than VFIO_PIN_PAGES_MAX_ENTRIES.
 * Return error or number of pages unpinned.
 */
int vfio_unpin_pages(struct vfio_device *device, unsigned long user_iova,
		     int npage)
{
	struct vfio_container *container;
	struct vfio_iommu_driver *driver;
