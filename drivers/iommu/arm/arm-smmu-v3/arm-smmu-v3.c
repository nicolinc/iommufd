...
static const struct iommu_domain_ops arm_smmu_nested_domain_ops = {
	...
	.cache_invalidate_user_data_len = {
		.min = offsetofend(struct iommu_hwpt_arm_smmuv3_invalidate, __reserved),
		.max = sizeof(struct iommu_hwpt_arm_smmuv3_invalidate),
	},
};
...
static struct iommu_ops arm_smmu_ops = {
	...
	.domain_alloc_user_data_len = {
		.min = offsetofend(struct iommu_hwpt_arm_smmuv3, out_event_uptr),
		.max = sizeof(struct iommu_hwpt_arm_smmuv3),
	},
	...
	.dev_user_data_len	= {
		.min = offsetofend(struct iommu_dev_data_arm_smmuv3, sid),
		.max = sizeof(struct iommu_dev_data_arm_smmuv3),
	},
