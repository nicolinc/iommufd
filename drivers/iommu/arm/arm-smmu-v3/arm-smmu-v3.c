				      ...
				      const struct resource *res)
{
	...
	/*
	 * The RMM answers the same whether there is no VSMMU at this address or
	 * one whose base firmware got wrong, so there is nothing to tell apart
	 * here and no way to go on with the second.
	 */
