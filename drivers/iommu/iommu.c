...
/**
 * iommu_replace_group - replace the domain that a group is attached to
 ...
 *
 * Note that this API will be used by IOMMUFD, so fail drivers with no_iommufd.
 */
...
EXPORT_SYMBOL_NS_GPL(iommu_replace_group, IOMMUFD_INTERNAL);
