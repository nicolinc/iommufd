...
static const struct iommu_ops mock_ops = {
	...
	.domain_alloc_user_data_len = {
		.min = offsetofend(struct iommu_hwpt_selftest, test_config),
		.max = sizeof(struct iommu_hwpt_selftest),
	},
	...
	.dev_user_data_len = {
		.min = offsetofend(struct iommu_test_device_data, val),
		.max = sizeof(struct iommu_test_device_data),
	},
	.default_domain_ops =
