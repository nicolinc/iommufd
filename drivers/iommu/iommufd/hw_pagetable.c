			     ...
			     void *user_data)
{
	...
	refcount_set(&hwpt->device_users, 1);
	if (parent)
...
static const size_t iommufd_hwpt_info_size[] = {
	...
	[IOMMU_PGTBL_TYPE_ARM_SMMUV3] = sizeof(struct iommu_hwpt_arm_smmuv3),
};
...
static u32 iommufd_hwpt_invalidate_info_size[] = {
	...
	[IOMMU_PGTBL_TYPE_ARM_SMMUV3] = sizeof(struct iommu_hwpt_invalidate_arm_smmuv3),
};
