...
_iommufd_object_alloc_member(struct iommufd_ctx *ictx, size_t size,
			     enum iommufd_object_type type);

#define iommufd_object_alloc_member(ictx, ptr, type, obj)                      \
	container_of(_iommufd_object_alloc_member(                             \
			     ictx,                                             \
...
#define iommufd_object_alloc(ictx, ptr, type) \
	iommufd_object_alloc_member(ictx, ptr, type, obj)
