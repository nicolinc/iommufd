...
/**
 * iommufd_device_set_data - Set/unset an iommu specific device data
 ...
 *
 * This sets or unsets an iommu specific device data from the user space.
 * Leaving data_uptr and data_len both NULL can unset the user data.
 */
